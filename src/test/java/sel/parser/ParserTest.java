...
public class ParserTest {
    ...
    public void parseCommandType_recognisesAllKnownCommands() {
        ...
        assertEquals(
                CommandType.EVENT,
                Parser.parseCommandType(
                        "event meeting /from 2019-12-02 1400 /to 1600"));
    ...
    public void parseIndex_missingArgument_throwsWithMissingArgMessage() {
        SelException e = assertThrows(
                SelException.class, () -> Parser.parseIndex("mark", "mark", "missing arg", "invalid number"));
    ...
    public void parseSimpleArgument_commandWordOnly_throws() {
        SelException e = assertThrows(
                SelException.class, () -> Parser.parseSimpleArgument("todo", "todo", "empty task error"));
    ...
    public void parseDeadlineArgs_validCommand_extractsDescriptionAndDeadline() throws SelException {
        String[] args = Parser.parseDeadlineArgs(
                "deadline return book /by 2019-12-02 1800");
    ...
    public void parseDeadlineArgs_missingByMarker_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDeadlineArgs("deadline return book"));
    }

    @Test
    public void parseDeadlineArgs_emptyDescription_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDeadlineArgs("deadline /by 2019-12-02 1800"));
    }

    @Test
    public void parseDeadlineArgs_emptyDeadline_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDeadlineArgs("deadline return book /by"));
    }

    @Test
    public void parseDeadlineArgs_bareCommandWord_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDeadlineArgs("deadline"));
    }

    @Test
    public void parseEventArgs_validCommand_extractsAllThreeFields() throws SelException {
        String[] args = Parser.parseEventArgs(
    ...
    public void parseEventArgs_missingFromMarker_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseEventArgs("event project meeting /to 2019-12-02 1600"));
    }

    @Test
    public void parseEventArgs_missingToMarker_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseEventArgs("event project meeting /from 2019-12-02 1400"));
    }

    @Test
    public void parseEventArgs_emptyDescription_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseEventArgs("event /from 2019-12-02 1400 "
                                + "/to 2019-12-02 1600"));
    }
    ...
    public void parseEventArgs_emptyFrom_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseEventArgs("event meeting /from /to 2019-12-02 1600"));
    }

    @Test
    public void parseEventArgs_emptyTo_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseEventArgs("event meeting /from 2019-12-02 1400 /to"));
    }
    ...
    public void parseDateTime_missingTimeComponent_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDateTime("2019-12-02"));
    }

    @Test
    public void parseDateTime_wrongDateFormat_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDateTime("02-12-2019 1800"));
    }

    @Test
    public void parseDateTime_garbageInput_throws() {
        assertThrows(
                SelException.class, () -> Parser.parseDateTime("not a date"));
    }

    @Test
    public void parseDateTime_extraWhitespace_isTrimmedAndStillParses() throws SelException {
        LocalDateTime result = Parser.parseDateTime(
                "  2019-12-02 1800  ");
        assertEquals(LocalDateTime.of(2019, 12, 2, 18, 0), result);
    }
}
